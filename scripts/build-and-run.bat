...
rem Build command
go run -ldflags "-X github.com/keshon/discord-bot-template/internal/version.BuildDate=%BUILD_DATE% -X github.com/keshon/discord-bot-template/internal/version.GoVersion=%GO_VERSION%" cmd\dbt\dbt.go
