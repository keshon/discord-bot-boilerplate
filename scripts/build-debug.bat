...
rem Build command
go build -o dbt.exe -ldflags "-X github.com/keshon/discord-bot-template/internal/version.BuildDate=%BUILD_DATE% -X github.com/keshon/discord-bot-template/internal/version.GoVersion=%GO_VERSION%" cmd\dbt\dbt.go
